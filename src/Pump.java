...
public void update(){
	...
	System.out.println("Pump update powcurrent=" +powcurrent);
...
public void network(){	
	...
	if (powcurrent<30){		col=Color.RED;
		this.repaint();
		for (; powcurrent < 30;) {
			powcurrent++;

			System.out.println("Pump network powcurrent"+powcurrent);
			try {
				Thread.sleep(180);
			}
...
public void setpowcurrent(int p){powcurrent=p;}
